...
<img width="771" height="358" alt="image" src="https://github.com/user-attachments/assets/46c11ea9-c99d-41d7-b750-049e97a5d493" />

如何和把选定的基点数据挪到正确位置上，这是快速排序的核心，我们称为 Partition。

过程如下所示，其中 i 为当前遍历比较的元素位置：
<img width="868" height="281" alt="image" src="https://github.com/user-attachments/assets/d173917a-0298-46f3-8672-369ea5a7b3da" />
...
void randomized_quicksort(int arr[], int low, int high) {
    if (low < high) {
        // 通过RandomPivotPartition()随机选择pivot [[7]]
